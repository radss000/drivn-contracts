...
export interface EarnNFTInterface extends utils.Interface {
  functions: {
...
export interface EarnNFT extends BaseContract {
  ...
  functions: {
    ...
    setAllowed(
      allowedAddress: PromiseOrValue<string>,
  ...
  callStatic: {
    ...
    mint(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>
